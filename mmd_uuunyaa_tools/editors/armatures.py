...
mmd_rigify_bones = [
    ...
    MMDRigifyBone(MMDBoneType.STANDARD, '左つま先ＩＫ', None, None, GroupType.LEG_L, MMDBindType.NONE),
    MMDRigifyBone(MMDBoneType.STANDARD, '右つま先ＩＫ', None, None, GroupType.LEG_R, MMDBindType.NONE),
